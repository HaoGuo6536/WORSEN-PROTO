...
Read and follow the root [AGENTS.md](AGENTS.md) before working here. It is the shared entry point for architecture policy, planning and documentation skill boundaries, GitNexus, ast-grep, and Unity tooling. Keep project-specific instructions there rather than duplicating them in this file. Preserve this pointer outside the generated GitNexus block.
